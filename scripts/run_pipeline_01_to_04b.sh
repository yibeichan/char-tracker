...
SCENE_OUTPUT="${SCRATCH_DIR}/output/01_scene_detection/${VIDEO_NAME}.txt"
FACE_DETECTION_OUTPUT="${SCRATCH_DIR}/output/02_face_detection/${VIDEO_NAME}.json"
...
log_info "  - Cluster zip file:   ${SCRATCH_DIR}/output/04b_face_tracking_by_cluster/${VIDEO_NAME}.zip"
echo ""
